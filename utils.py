...
def get_labels():
        ...
        return ["O", "SIGN-I", "SIGN-B", "CHECK-I", "CHECK-B", "DIAGNOSIS-I", "DIAGNOSIS-B", "[CLS]", "[SEP]", '']
        #return ["O", "TREATMENT-I", "TREATMENT-B", "BODY-I", "BODY-B", "SIGNS-I", "SIGNS-B",
                #"CHECK-I", "CHECK-B",  "DISEASE-I", "DISEASE-B", "[CLS]", "[SEP]", '']
...
class DataIterator:
    ...
    数据迭代器
    """
    def __init__(self, batch_size, data_file, tokenizer, use_bert=False, seq_length=128, is_test=False,):
        ...
        print('unk:', self.unknow_tokens)
        print('number', self.num_records)
...
if __name__ == '__main__':
    ...
    dev_iter = DataIterator(config.batch_size, data_file=config.new_data_process_quarter_final + 'dev.txt', use_bert=config.use_bert,
                            tokenizer=tokenizer,
    ...
    for input_ids_list, input_mask_list, segment_ids_list, label_ids_list, seq_length, tokens_list in tqdm(dev_iter):
       # print(input_ids_list, input_mask_list, segment_ids_list, label_ids_list, seq_length, tokens_list)
        print(seq_length)
