...
import sys
sys.path.append("/home/wyang/wyang19/clean_ner")  # 添加项目根路径，避免在服务器上调用代码时找不到上一级目录的模块
...
if __name__ == '__main__':
    ...
    remove_list = [
        'test_result_detail_model_0.6774_0.7129-6235.txt',  
        'test_result_detail_model_0.6841_0.6867-4988.txt',  
                   ]
    # 测试集
